...
#   bash wait_for_gpus_and_launch.sh
...
OUTDIR=data/ai-usage-generations/v3
LOG="$WORKDIR/generate_v3.log"

# Previous generation directories
V1DIR=data/ai-usage-generations
V2DIR=data/ai-usage-generations/v2
...
echo "$(date): Results: $OUTDIR/ai_usage_results.csv.gz" | tee -a "$LOG"
