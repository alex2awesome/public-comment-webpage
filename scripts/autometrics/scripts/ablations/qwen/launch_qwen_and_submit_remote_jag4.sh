...
# Orchestrator (jagupard 4xGPU): starts a persistent Qwen server on this node and submits
# one or more jagupard ablation jobs that connect to it via QWEN_API_BASE.
#
# Optional env:
