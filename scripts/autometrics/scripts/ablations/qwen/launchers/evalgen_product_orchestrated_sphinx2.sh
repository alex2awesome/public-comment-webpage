...
# Example launcher: EvalGenProduct with orchestrated mode on sphinx (server TP=2)
# Usage:
#   bash scripts/ablations/qwen/launchers/evalgen_product_orchestrated_sphinx2.sh
...
echo "Submitting orchestrator for EvalGenProduct (SEEDS=[$SEEDS], FULL_SUITE=$FULL_SUITE) on sphinx TP=${TP}"
