...
# Example launcher: Primock57 with orchestrated mode on jagupard (server TP=4)
# Usage:
#   bash scripts/ablations/qwen/launchers/primock57_timesec_orchestrated_jag4.sh
...
echo "Submitting orchestrator for Primock57 (SEEDS=[$SEEDS], FULL_SUITE=$FULL_SUITE) on jagupard TP=${TP}"
