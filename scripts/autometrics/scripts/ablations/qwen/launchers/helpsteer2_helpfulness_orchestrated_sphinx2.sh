...
# Example launcher: HelpSteer2 with orchestrated mode on sphinx (server TP=2)
# Usage:
#   bash scripts/ablations/qwen/launchers/helpsteer2_orchestrated_sphinx2.sh
...
echo "Submitting orchestrator for HelpSteer2 (SEEDS=[$SEEDS], FULL_SUITE=$FULL_SUITE) on sphinx TP=${TP}"
