...
# Example launcher: Primock57 with orchestrated mode on sphinx2 (server TP=2)
# Usage:
#   bash scripts/ablations/qwen/launchers/primock57_timesec_orchestrated_sphinx2.sh
...
TARGET_MEASURE=${TARGET_MEASURE:-"time_sec"}
...
echo "Submitting orchestrator for Primock57 (SEEDS=[$SEEDS], FULL_SUITE=$FULL_SUITE) on sphinx2 TP=${TP}"
