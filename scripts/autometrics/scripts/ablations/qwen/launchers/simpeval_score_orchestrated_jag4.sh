...
# Example launcher: SimpEval with orchestrated mode on jagupard (server TP=4)
# Usage:
#   bash scripts/ablations/qwen/launchers/simpeval_score_orchestrated_jag4.sh
...
echo "Submitting orchestrator for SimpleVal (SEEDS=[$SEEDS], FULL_SUITE=$FULL_SUITE) on jagupard TP=${TP}"
