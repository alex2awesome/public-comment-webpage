...
# Example launcher: EvalGenProduct with orchestrated mode on jagupard (server TP=4)
# Usage:
#   bash scripts/ablations/qwen/launchers/evalgen_product_orchestrated_jag4.sh
