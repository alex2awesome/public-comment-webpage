...
#SBATCH --nodes=1
#SBATCH --job-name=finetune_simplification
#SBATCH --output=scripts/finetune/logs/finetune_simplification.out
#SBATCH --error=scripts/finetune/logs/finetune_simplification.err
#SBATCH --constraint=[141G|80G]
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for Simplification datasets with fine-tuned ModernBERT metrics
...
echo "Starting Fine-tuned Metric analysis for Simplification datasets..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_finetune_simplification"
...
echo "Simplification datasets analysis completed!"
...
echo "  - Total training runs: 20 (4 combinations × 5 seeds)"
echo ""
echo "Expected output files:"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_kendall_SimpDA.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_kendall_SimpEval.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_pearson_SimpDA.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_pearson_SimpEval.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_spearman_SimpDA.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_spearman_SimpEval.csv"
echo ""
...
print('=== Fine-tuned Metric Simplification Results Summary ===')

correlation_types = ['kendall', 'pearson', 'spearman']
datasets = ['SimpDA', 'SimpEval']
...
echo ""
echo "Fine-tuned metric Simplification analysis completed!" 