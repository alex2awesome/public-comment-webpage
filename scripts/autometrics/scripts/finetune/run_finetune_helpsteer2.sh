...
#SBATCH --nodes=1
#SBATCH --job-name=finetune_helpsteer2
#SBATCH --output=scripts/finetune/logs/finetune_helpsteer2.out
#SBATCH --error=scripts/finetune/logs/finetune_helpsteer2.err
#SBATCH --constraint=[141G|80G]
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for HelpSteer2 dataset with fine-tuned ModernBERT metrics
...
echo "Starting Fine-tuned Metric analysis for HelpSteer2 dataset..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_finetune_helpsteer2"
...
# Run the analysis for HelpSteer2 dataset
...
echo "HelpSteer2 dataset analysis completed!"
echo "Individual dataset files saved in: results/main_runs/baselines/finetune_sub_results/"

echo ""
echo "Summary of processed dataset:"
echo "  - HelpSteer2: 5 measures (helpfulness, correctness, coherence, complexity, verbosity)"
echo "  - Total: 5 dataset-measure combinations"
echo "  - Total training runs: 25 (5 combinations × 5 seeds)"
echo ""
echo "Expected output files:"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_kendall_HelpSteer2.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_pearson_HelpSteer2.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_spearman_HelpSteer2.csv"
echo ""
...
print('=== Fine-tuned Metric HelpSteer2 Results Summary ===')
...
echo ""
echo "Fine-tuned metric HelpSteer2 analysis completed!" 