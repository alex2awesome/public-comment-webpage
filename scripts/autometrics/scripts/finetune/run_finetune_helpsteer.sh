...
#SBATCH --nodes=1
#SBATCH --job-name=finetune_helpsteer
#SBATCH --output=scripts/finetune/logs/finetune_helpsteer.out
#SBATCH --error=scripts/finetune/logs/finetune_helpsteer.err
#SBATCH --constraint=[141G|80G]
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for HelpSteer dataset with fine-tuned ModernBERT metrics
...
echo "Starting Fine-tuned Metric analysis for HelpSteer dataset..."
echo "Processing dataset: HelpSteer"
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_finetune_helpsteer"
...
# Run the analysis for HelpSteer dataset
...
echo "HelpSteer dataset analysis completed!"
echo "Individual dataset files saved in: results/main_runs/baselines/finetune_sub_results/"

echo ""
echo "Summary of processed dataset:"
echo "  - HelpSteer: 5 measures (helpfulness, correctness, coherence, complexity, verbosity)"
echo "  - Total: 5 dataset-measure combinations"
echo "  - Total training runs: 25 (5 combinations × 5 seeds)"
echo ""
echo "Expected output files:"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_kendall_HelpSteer.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_pearson_HelpSteer.csv"
echo "  - results/main_runs/baselines/finetune_sub_results/finetune_spearman_HelpSteer.csv"
echo ""
...
print('=== Fine-tuned Metric HelpSteer Results Summary ===')
...
for corr_type in correlation_types:
    ...
    if os.path.exists(filepath):
        ...
        print(f'  {dataset}: {total_metrics} metrics processed')
        ...
        print(f'  No results file found: {filepath}')
"

echo ""
echo "Fine-tuned metric HelpSteer analysis completed!" 