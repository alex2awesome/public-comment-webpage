...
#SBATCH --nodes=1
#SBATCH --job-name=finetune_remaining
#SBATCH --output=scripts/finetune/logs/finetune_remaining.out
#SBATCH --error=scripts/finetune/logs/finetune_remaining.err
#SBATCH --constraint=[141G|80G]
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for remaining datasets with fine-tuned ModernBERT metrics
...
echo "Starting Fine-tuned Metric analysis for remaining datasets..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_finetune_remaining"
...
echo "  - Total: 11 dataset-measure combinations"
echo "  - Total training runs: 55 (11 combinations × 5 seeds)"
echo ""
echo "Expected output files:"
for dataset in EvalGenMedical EvalGenProduct Primock57 RealHumanEval SummEval; do
...
print('=== Fine-tuned Metric Remaining Datasets Results Summary ===')

correlation_types = ['kendall', 'pearson', 'spearman']
datasets = ['EvalGenMedical', 'EvalGenProduct', 'Primock57', 'RealHumanEval', 'SummEval']
...
echo ""
echo "Fine-tuned metric remaining datasets analysis completed!" 