...
#SBATCH --nodes=1
#SBATCH --job-name=dna_eval_qwen_helpsteer2
#SBATCH --output=scripts/dna_eval/logs/dna_eval_qwen_helpsteer2.out
#SBATCH --error=scripts/dna_eval/logs/dna_eval_qwen_helpsteer2.err
...
echo "Starting Qwen3-32B server for DNAEval HelpSteer2..."
...
echo "Starting DNAEval analysis with Qwen3-32B for HelpSteer2 datasets..."
