...
#SBATCH --job-name=dna_eval_gpt4o_helpsteer
#SBATCH --output=scripts/dna_eval/logs/dna_eval_gpt4o_helpsteer.out
#SBATCH --error=scripts/dna_eval/logs/dna_eval_gpt4o_helpsteer.err
...
# GPT-4o-mini DNAEval Correlation Analysis - HelpSteer Dataset
...
echo "Starting GPT-4o-mini DNAEval correlation analysis for HelpSteer dataset..."

# Set DSPy cache directory (separate from others to avoid conflicts)
export DSPY_CACHEDIR="./.cache/dspy_dna_eval_gpt4o_helpsteer"

# Ensure output directories exist
mkdir -p results/main_runs/baselines/dna_eval_sub_results
mkdir -p scripts/dna_eval/logs

# Run all three correlation types for HelpSteer
...
echo "GPT-4o-mini DNAEval correlation analysis for HelpSteer completed!"
