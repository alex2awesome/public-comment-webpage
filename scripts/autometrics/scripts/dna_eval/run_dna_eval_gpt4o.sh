...
#SBATCH --nodes=1
#SBATCH --job-name=dna_eval_gpt4o
#SBATCH --output=scripts/dna_eval/logs/dna_eval_gpt4o.out
#SBATCH --error=scripts/dna_eval/logs/dna_eval_gpt4o.err
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Production script for DNAEval correlation stability analysis
# Using GPT-4o-mini on all available datasets
...
echo "Starting DNAEval Production Run with GPT-4o-mini..."
...
echo "Results saved to: results/main_runs/baselines/dna_eval_gpt4o_mini_*.csv"
...
for corr_type in correlation_types:
    filepath = f'results/main_runs/baselines/dna_eval_gpt4o_mini_{corr_type}.csv'
...
echo ""
echo "DNAEval GPT-4o production run completed!"
