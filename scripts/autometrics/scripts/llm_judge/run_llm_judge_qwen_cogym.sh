...
#SBATCH --nodes=1
#SBATCH --job-name=llm_judge_qwen_cogym
#SBATCH --output=scripts/llm_judge/logs/llm_judge_qwen_cogym.out
#SBATCH --error=scripts/llm_judge/logs/llm_judge_qwen_cogym.err
...
port=7400  # Different port to avoid conflicts
model_nickname="qwen3_32b"

echo "Starting Qwen3-32B server for CoGym datasets..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_qwen3_32b_cogym"

# Set API base URL
API_BASE=http://localhost:${port}/v1

echo "Starting LLM Judge analysis with Qwen3-32B for CoGym datasets..."
