...
#SBATCH --job-name=llm_judge_gpt4o_helpsteer
#SBATCH --output=scripts/llm_judge/logs/llm_judge_gpt4o_helpsteer.out
#SBATCH --error=scripts/llm_judge/logs/llm_judge_gpt4o_helpsteer.err
...
export DSPY_CACHEDIR="./.cache/dspy_llm_judge_gpt4o_helpsteer1"
