...
#SBATCH --nodes=1
#SBATCH --job-name=llm_judge_gpt4o
#SBATCH --output=scripts/llm_judge/logs/llm_judge_gpt4o.out
#SBATCH --error=scripts/llm_judge/logs/llm_judge_gpt4o.err
#SBATCH --requeue
...
echo "Starting LLM Judge Production Run with GPT-4o-mini..."
...
for corr_type in correlation_types:
    filepath = f'results/main_runs/baselines/llm_judge_gpt4o_mini_{corr_type}.csv'
...
echo ""
echo "LLM Judge GPT-4o production run completed!" 