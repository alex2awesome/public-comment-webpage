...
#SBATCH --nodes=1
#SBATCH --job-name=metric_gen_gpt4o_remaining
#SBATCH --output=scripts/metric_generation/logs/metric_gen_gpt4o_remaining.out
#SBATCH --error=scripts/metric_generation/logs/metric_gen_gpt4o_remaining.err
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for remaining datasets with GPT-4o-mini
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_gpt4o_remaining"
...
echo "Starting Metric Generation Benchmark with GPT-4o-mini for remaining datasets..."
...
echo "Remaining datasets benchmark completed with GPT-4o-mini!"
