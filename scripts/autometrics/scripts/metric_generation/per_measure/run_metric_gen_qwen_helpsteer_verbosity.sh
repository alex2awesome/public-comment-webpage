...
#SBATCH --nodes=1
#SBATCH --job-name=metric_gen_qwen_helpsteer_verbosity
#SBATCH --output=scripts/metric_generation/logs/metric_gen_qwen_helpsteer_verbosity.out
#SBATCH --error=scripts/metric_generation/logs/metric_gen_qwen_helpsteer_verbosity.err
...
echo "Starting Qwen3-32B server for HelpSteer (verbosity)..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_qwen_helpsteer_verbosity"
export AUTOMETRICS_MODEL_DIR="/sphinx/u/salt-checkpoints/autometrics/models"

echo "Starting Metric Generation Benchmark with Qwen3-32B for HelpSteer (verbosity)..."
...
echo "HelpSteer (verbosity) benchmark completed with Qwen3-32B!"
