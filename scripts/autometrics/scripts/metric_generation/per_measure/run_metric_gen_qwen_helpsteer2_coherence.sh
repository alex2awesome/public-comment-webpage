...
#SBATCH --nodes=1
#SBATCH --job-name=metric_gen_qwen_helpsteer2_coherence
#SBATCH --output=scripts/metric_generation/logs/metric_gen_qwen_helpsteer2_coherence.out
#SBATCH --error=scripts/metric_generation/logs/metric_gen_qwen_helpsteer2_coherence.err
...
echo "Starting Qwen3-32B server for HelpSteer2 (coherence)..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_qwen_helpsteer2_coherence"
export AUTOMETRICS_MODEL_DIR="/sphinx/u/salt-checkpoints/autometrics/models"

echo "Starting Metric Generation Benchmark with Qwen3-32B for HelpSteer2 (coherence)..."
...
echo "HelpSteer2 (coherence) benchmark completed with Qwen3-32B!"
