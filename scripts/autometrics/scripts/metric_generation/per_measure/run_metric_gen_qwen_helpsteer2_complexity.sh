...
#SBATCH --nodes=1
#SBATCH --job-name=metric_gen_qwen_helpsteer2_complexity
#SBATCH --output=scripts/metric_generation/logs/metric_gen_qwen_helpsteer2_complexity.out
#SBATCH --error=scripts/metric_generation/logs/metric_gen_qwen_helpsteer2_complexity.err
...
echo "Starting Qwen3-32B server for HelpSteer2 (complexity)..."
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_qwen_helpsteer2_complexity"
export AUTOMETRICS_MODEL_DIR="/sphinx/u/salt-checkpoints/autometrics/models"

echo "Starting Metric Generation Benchmark with Qwen3-32B for HelpSteer2 (complexity)..."
...
echo "HelpSteer2 (complexity) benchmark completed with Qwen3-32B!"
