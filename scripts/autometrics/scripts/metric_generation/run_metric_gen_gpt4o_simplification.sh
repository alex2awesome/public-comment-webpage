...
#SBATCH --nodes=1
#SBATCH --job-name=metric_gen_gpt4o_simplification
#SBATCH --output=scripts/metric_generation/logs/metric_gen_gpt4o_simplification.out
#SBATCH --error=scripts/metric_generation/logs/metric_gen_gpt4o_simplification.err
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for Simplification datasets with GPT-4o-mini
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_gpt4o_simplification"
...
echo "Starting Metric Generation Benchmark with GPT-4o-mini for Simplification datasets..."
...
echo "Simplification datasets benchmark completed with GPT-4o-mini!"
