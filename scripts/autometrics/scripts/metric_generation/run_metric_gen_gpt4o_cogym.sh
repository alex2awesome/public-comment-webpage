...
#SBATCH --nodes=1
#SBATCH --job-name=metric_gen_gpt4o_cogym
#SBATCH --output=scripts/metric_generation/logs/metric_gen_gpt4o_cogym.out
#SBATCH --error=scripts/metric_generation/logs/metric_gen_gpt4o_cogym.err
#SBATCH --requeue
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=mryan0@stanford.edu

# Script for CoGym datasets with GPT-4o-mini
...
export DSPY_CACHEDIR="/nlp/scr3/nlp/20questions/dspy_cache/autometrics_metric_gen_gpt4o_cogym"
...
echo "Starting Metric Generation Benchmark with GPT-4o-mini for CoGym datasets..."
...
echo "CoGym datasets benchmark completed with GPT-4o-mini!"
