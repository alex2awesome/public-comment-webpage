...
#SBATCH --time=7:00:00
#SBATCH --nodes=1
#SBATCH --job-name=rb_benchmark_utilization
#SBATCH --output=logs/rb_benchmark_utilization.out
#SBATCH --error=logs/rb_benchmark_utilization.err
...
python autometrics/experiments/utilization/benchmark_utilization.py --skip-reference-free