...
export TORCH_EXTENSIONS_DIR="/nlp/scr3/nlp/20questions/torch_extensions_cache/ablation_qwen_${DATASET_NAME}_${TARGET_MEASURE}_${ABLA_TAG}_seed${SEED}"
export TRITON_CACHE_DIR="/nlp/scr3/nlp/20questions/triton_cache/ablation_qwen_${DATASET_NAME}_${TARGET_MEASURE}_${ABLA_TAG}_seed${SEED}"
